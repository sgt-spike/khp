<?php
   $q = $_GET['q'];
   if ($q == 'TheBoard') {
      $markup = '<h1 id="board-h1" class="main-h1">The Board</h1>
      <div id="board">
       ...
       $markup = '
       <div class="div-arrow">
         <a id="arrow" href="whoweare.php?q=TheBoard" target="_self"><i class="fas fa-angle-double-left">THE BOARD</i></a>
       </div>
       <div class="container-art">
         ...
         <div class="div-art">
            <h2 id="h2-execdir" class="whoweare-h2" >Darlis Meyer - Founder/Executive Director</h2>
      ...
      <div class="container-art">
         ...
         <div class="div-art">
            <h2 id="h2-execdir" class="whoweare-h2">Debbie Soares - Founding President</h2>
            <article id="art-execdir" class="whoweare-art">
               ...
               <p id="p4">Should you have any questions, ideas, comments, or concerns, please contact me at (907) 240-2030 or Email <a href="debbie@katieshandprint.org">debbie@katieshandprint.org</a></p>
            </article>
         </div>
      </div>';
   } elseif ($q == 'us3') {
      ...
      <div class="container-art">
         ...
         <div class="div-art">
            <h2 id="h2-vp" class="whoweare-h2">Jessica Jacobsen - Founding Vice President</h2>
      ...
      <div class="container-art">
         ...
         <div class="div-art">
            <h2 id="h2-treasurer" class="whoweare-h2">Lee Ann Eissler, PhD, FNP, RN - Founding Treasurer</h2>
      ...
      <div class="container-art">
         ...
         <div class="div-art">
            <h2 id="h2-secretary" class="whoweare-h2">Amber Leach - Founding Secretary</h2>
      ...
      $markup = '<div class="div-arrow"><a id="arrow" href="familystories.php?q=stories" target="_self"><i class="fas fa-angle-double-left">THE FAMILIES</i></a></div><h1 id="heading-danica" class="main-h1">Danica</h1>
