<?php
   $q = $_REQUEST['q'];
   if ($q == 'all') {
      $page->markup = '<h1 id="board-h1">The Board</h1>
      <div id="board">
         <div id="us1" class="gallery">
            <div class="desc top">Executive Director</div>
            <img src="img/Darlis_board.jpg" alt="Founder and Executive" class="allImg">
       ...
       $page->markup = '<i id="arrow" class="fas fa-angle-double-left" onclick="initialLoad;">THE BOARD</i><img id="img-execdir" class="whoweare-img" src="img/Darlis+and+Howie+Photo.jpg"><h3 id="h3-execdir" class="whoweare-h3" >Darlis Meyer - Founder/Executive Director</h3>
      ...
      $page->markup = '<i id="arrow" class="fas fa-angle-double-left">THE BOARD</i><img id="img-founder" class="whoweare-img" src="img/Debbie+Photo.jpg" >
      ...
      $page->markup = '<i id="arrow" class="fas fa-angle-double-left">THE BOARD</i><img id="img-vp" class="whoweare-img" src="img/Jessica+Photo.jpg" >
      ...
      $page->markup = '<i id="arrow" class="fas fa-angle-double-left">THE BOARD</i><img id="img-treasurer" class="whoweare-img" src="img/IMHL+photo.jpg" >
      ...
      $page->markup =  '<i id="arrow" class="fas fa-angle-double-left">THE BOARD</i><img id="img-secretary" class="whoweare-img" src="img/Amber+Photo.jpg" >
